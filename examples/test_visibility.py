...
from pb_planning.pybullet_tools.pr2_utils import HEAD_LINK_NAME, PR2_GROUPS, get_viewcone, get_detections, \
    REST_LEFT_ARM, rightarm_from_leftarm, inverse_visibility, get_detection_cone, visible_base_generator, \
    DRAKE_PR2_URDF
from pb_planning.pybullet_tools import disconnect, HideOutput, \
    ...
    remove_body, RED, BLUE, add_line, draw_point
